---
title: "Statistical Inference:ToothGrowth exploratory data analysis"
...
The box plots display increasing the dosage increases the tooth growth. Orange
...
#### Hypothesis #1
Orange juice & ascorbic acid result in the same tooth growth across the data set.
```{r}
...
0.05 threshold. The null hypothesis can be rejected and the alternative hypothesis 
